...
export const ICONS = {
  ...
  water: S('<path d="M4.5 10h9.5v8a2 2 0 0 1-2 2H6.5a2 2 0 0 1-2-2Z"/><path d="M14 12.5 19 8.2M17.6 6.8l2.8 2.8"/><path d="M4.5 12.5H3.6a1.8 1.8 0 0 1 0-3.6h.9"/><path d="M19.8 13v.6M21 15.8v.6M18.4 16.8v.6"/>'),
